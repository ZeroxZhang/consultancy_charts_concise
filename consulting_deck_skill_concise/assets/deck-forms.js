...
const FORMS = {
  ...
  'kit.mekko': { family: 'composition', label: '百分轴 Mekko', kind: 'svg', module: 'exhibit-kit', export: 'mekko', annotation: 'layer', capacity: '列 ≤ 6；窄列连序号都放不下就改表' },
  'kit.stacked': { family: 'composition', label: '堆积构成', kind: 'svg', module: 'exhibit-kit', export: 'stacked', annotation: 'layer', capacity: '列 ≤ 12 × 系列 ≤ 6；仅非负组成' },

...
if(!input||!output)throw Error('用法: node scripts/apply_theme.cjs assets/deck_engine.html output.html [mckinsey|bcg|accenture] [serif-report|serif-playfair|sans-presentation|legacy-system]');
...
html=require('./pack_fonts.cjs').pack(html,{profile});
